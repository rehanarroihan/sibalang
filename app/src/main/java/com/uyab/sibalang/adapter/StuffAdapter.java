...
public class StuffAdapter extends RecyclerView.Adapter<StuffAdapter.ViewHolder> {
    ...
    public StuffAdapter(ArrayList<Stuff> stuff, StuffInterface stuffInterface, Context context) {
        this.stuff = stuff;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.stuff_row, viewGroup, false);
